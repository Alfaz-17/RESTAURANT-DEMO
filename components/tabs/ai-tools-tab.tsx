    ...
    <div className="grid grid-cols-1 gap-4 sm:gap-6">
      <div className="luxury-card p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row items-start justify-between gap-3 sm:gap-0 mb-4">
          <div>
            <h3 className="font-serif text-lg sm:text-xl font-light">AI-Powered Tools</h3>
          ...
          <a
            ...
            className="text-xs px-4 py-2 bg-accent text-accent-foreground rounded-xl hover:bg-accent/90 transition-all active:scale-[0.98] font-medium shadow-sm"
          >
            Setup Credit
          </a>
        </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] sm:text-xs text-muted-foreground mt-1 line-clamp-2">{tool.description}</div>
                  </div>
                </div>
              </button>
            )
        ...
        {aiResponse && (
          <div className="bg-muted p-3 sm:p-4 rounded-xl border border-border/50 whitespace-pre-wrap text-[10px] sm:text-sm leading-relaxed font-light overflow-auto max-h-96 scrollbar-hide">
            {aiResponse}
          </div>
        )}
